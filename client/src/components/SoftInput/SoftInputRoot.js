...
export default styled(InputBase)(({ theme, ownerState }) => {
  ...
  const withIconStyles = () => {
    const withIconBorderRadiusValue = iconDirection === "right" ? `${borderRadius.md} 0 0 ${borderRadius.md}` : `0 ${borderRadius.md} ${borderRadius.md} 0`;
    const withIconPaddingLeftValue = iconDirection === "right" ? pxToRem(12) : 0;
    const withIconPaddingRightValue = iconDirection === "right" ? 0 : pxToRem(12);
    return {
